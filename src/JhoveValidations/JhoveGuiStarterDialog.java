...
//There is an issue with the conf- file. The conf file needs to be here: C:\Users\Friese Yvonne\jhove\conf\jhove.conf
...
public class JhoveGuiStarterDialog {
	...
	public static void main(String args[]) throws Exception {
		changecolor();
		String path = "D://Benutzer//jhove-logo_small.gif";
		...
		int inteingabe = JOptionPane.showOptionDialog(null, "Which file format do you want to validate?",
				"Jhove Validation", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, icon, options,
				options[6]);

		JOptionPane.showMessageDialog(null, "Please choose the folder with files to validate.", "JHOVE Examination",
				JOptionPane.QUESTION_MESSAGE);
		jhoveExaminationFolder = Utilities.BrowserDialogs.chooseFolder();
		...
		case 7:
			...
			break;
		default:
			JOptionPane.showMessageDialog(null, "Nothing will be done. Please choose properly.", "Misbehaviour",
